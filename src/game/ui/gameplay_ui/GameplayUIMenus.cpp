...
void GameplayUI::DeathMenu()
{
    ...
    DrawText(txt_2.c_str(), GetRenderWidth() / 2 - size2 / 2, ey + es * 2 - DeathTextAnimRot, es,
...
void GameplayUI::PauseMenu()
{
    ...
    if (!IsChangingSettings)
    {
        ...
        game->Paused = !Button({
                               ...
                               GetMousePosition(), game->GameShared->SharedUIAssets.ButtonImg,
                               game->GameShared->SharedUIAssets.ButtonClick, "RESUME");
        ...
        if (Button({
                   ...
                   game->GameShared->SharedUIAssets.ButtonClick, "QUIT"))
    ...
    else
    {
        ...
        IsChangingSettings = !Button({
                                     ...
                                     game->GameShared->SharedUIAssets.ButtonImg,
                                     game->GameShared->SharedUIAssets.ButtonClick, "BACK");
    }
